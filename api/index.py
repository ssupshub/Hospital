...
# On Vercel, it looks for .env in root or uses dashboard variables.
# We look one level up since index.py is in api/
...
def health_check():
    try:
        ...
        return jsonify({"status": "ok", "database": "connected", "mode": "vercel"})
